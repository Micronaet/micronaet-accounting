...
class AccountAnalyticAccountMultipartner(osv.osv):
    ''' Add more than one reference partner in account analytic account
    ...
    _columns = {
        'extra_address': fields.selection([
            ...
            ('contact', 'Contact'),
            ('partner', 'Partner'), ], 
                'Extra address', select=True, required=True),
        'partner_ids': fields.many2many(
            'res.partner', 'account_analytic_partner_rel', 
